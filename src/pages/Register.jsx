    ...
    <div className="pt-32 pb-20 min-h-screen bg-brand-ivory">
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-serif text-brand-black mb-6">Register Here</h1>
        ...
        <motion.div 
          ...
          className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl shadow-brand-bronze/10 border border-brand-beige p-8 md:p-12"
        >
          <form className="space-y-6">
            ...
            <button type="button" className="w-full py-4 bg-brand-gold text-white font-medium rounded-lg hover:bg-brand-bronze transition-all flex items-center justify-center group shadow-xl shadow-brand-gold/20">
